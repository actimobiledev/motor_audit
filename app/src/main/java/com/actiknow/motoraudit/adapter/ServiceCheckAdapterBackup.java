...
public class ServiceCheckAdapterBackup extends BaseAdapter {
    ...
    public ServiceCheckAdapterBackup (Activity activity, List<ServiceCheck> serviceCheckList, int group_id) {
