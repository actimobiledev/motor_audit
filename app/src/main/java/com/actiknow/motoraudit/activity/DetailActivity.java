...
//                    Utils.showLog (Log.INFO, "WORK ORDER CUSTOMER SIGNATURE", Constants.workOrderDetail.getCustomer_signature (), true);
    ...
    private void initData () {
        ...
        lvFuelSystem.setScrollingCacheEnabled (false);
        lvPreStartChecksCoolingSystem.setScrollingCacheEnabled (false);
        lvLubricationSystem.setScrollingCacheEnabled (false);
        lvAirSystem.setScrollingCacheEnabled (false);
        lvExhaustSystem.setScrollingCacheEnabled (false);
        lvGenerator.setScrollingCacheEnabled (false);
        lvControlPanelCabinets.setScrollingCacheEnabled (false);
        lvATSMain.setScrollingCacheEnabled (false);
        lvStartingSystem.setScrollingCacheEnabled (false);
        lvGeneratorEnclosure.setScrollingCacheEnabled (false);
        lvStartupAndRunningCheck.setScrollingCacheEnabled (false);
        lvScheduledMaintenance.setScrollingCacheEnabled (false);
